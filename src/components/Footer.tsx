  ...
  return (
    ...
    >
      <defs>
        ...
        <filter id="masTrishulGlowFooter" x="-80%" y="-80%" width="260%" height="260%">
      ...
      <g
        stroke="url(#masTrishulGoldFooter)"
        strokeWidth="2.85"
        strokeLinecap="round"
        strokeLinejoin="round"
        filter="url(#masTrishulGlowFooter)"
      >
        <path d="M28 74V30" />
        <path d="M28 30V9" />
        <path d="M28 22 11 7" />
...
export default function Footer() {
  const whatsappHref =
    ...
    "https://wa.me/?text=" +
      encodeURIComponent("Hi MAS TECH, I want a demo. Please share details.");
  const calendlyUrl =
    String(import.meta.env.VITE_CALENDLY_URL || "").trim() || "https://calendly.com/";
    ...
    <footer className="mt-20 border-t border-[#ffd700]/10 bg-black/40">
      <div className="mx-auto max-w-6xl px-4 py-12">
        <div className="grid gap-10 lg:grid-cols-3">
          ...
          {/* ── Brand column ── */}
          <div>
            <div className="text-lg font-black text-white" style={{ fontFamily: '"Cinzel", serif' }}>
              MAS TECH
            </div>
            <p className="mt-2 max-w-sm text-sm text-mas-muted">
              AI software for Hospital OS, Retail POS, School ERP, and Custom AI. Built in
              Ahmedabad, focused on Gujarat.
            </p>
            <div className="mt-4">
              <TrustBadge />
            </div>
          ...
          <div className="text-sm">
            ...
            <div className="mt-6 font-bold text-white">Social proof</div>
            <div className="mt-3 flex flex-wrap gap-2">
              <a
                href={String(import.meta.env.VITE_LINKEDIN_URL || "").trim() || "#"}
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-xl border border-white/10 bg-white/5 px-4 py-2 font-bold text-white/80 hover:bg-white/10"
              >
                LinkedIn
              </a>
              <a
                href={String(import.meta.env.VITE_INSTAGRAM_URL || "").trim() || "#"}
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-xl border border-white/10 bg-white/5 px-4 py-2 font-bold text-white/80 hover:bg-white/10"
              >
          ...
          <div className="text-sm">
            ...
            <p className="mt-3 text-mas-muted">
              Local team. Fast support. On-site onboarding if needed.
            </p>
            <div className="mt-4 flex flex-wrap gap-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-xl bg-emerald-500 px-4 py-2 font-black uppercase tracking-wider text-emerald-950 hover:brightness-110"
              >
                WhatsApp
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 px-4 py-2 font-black uppercase tracking-wider text-mas-bg hover:brightness-110"
              >
                Calendly
              </a>
              {publicContactEmail && (
            ...
            <div className="mt-5 overflow-hidden rounded-2xl border border-white/10 bg-black/30">
              <iframe
                title="MAS TECH location (Ahmedabad, Gujarat)"
                src="https://www.google.com/maps?q=Ahmedabad%2C%20Gujarat&output=embed"
                loading="lazy"
        ...
        {/* ── Bottom seal — POWERED BY MAS TECH ── */}
        <div className="mt-10 flex flex-col items-center justify-center gap-3">
          ...
          >
            ...
            <a
              ...
              style={{
                textShadow:
                  "0 0 12px rgba(255,215,0,0.55), 0 0 24px rgba(255,200,80,0.3)",
              }}
            >
              MAS TECH
            </a>
          ...
          {/* © GURJAR Enterprise line */}
          <p className="text-center text-sm text-mas-muted">
            © 2026 MAS TECH Automation —{" "}
            <span className="text-white/90">A </span>
            <span
              className="font-playfair text-base font-semibold tracking-wide text-[#ffd700] drop-shadow-[0_0_18px_rgba(255,215,0,0.35)]"
            >
              GURJAR
            </span>
